    ...
    <div className="bg-white min-h-screen text-slate-900 antialiased overflow-x-hidden">
      <main className="max-w-7xl mx-auto px-6 py-10 lg:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-32 items-start">
          {/* Left Side: Gallery (Smaller - 5 Columns) */}
          ...
          {/* Right Side: Product Info (Wider - 7 Columns) */}
          <div className="lg:col-span-7 flex flex-col">
            <div className="space-y-4">
              {/* Stock Indicator using secondary color #F28F24 */}
              <div className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-widest text-[#1976BA] font-firaGo400">
                <span
            ...
            {/* Price Display using main color #1976BA */}
            <div className="pt-8 pb-4">
              {isPriceZero ? (
                ...
                <div className="flex items-baseline gap-5">
                  <span className="text-5xl font-extralight tracking-tighter text-[#1976BA] font-lgv">
                    {displayPrice.toLocaleString()}₾
                  </span>
                  {hasDiscount && (
                    <span className="text-2xl text-slate-300 line-through font-extralight font-lgv">
            ...
            {/* Description - NOW DIRECTLY UNDER PRICE */}
            ...
            {/* Contact Actions (Preserving original colors as requested) */}
