...
export const PromoBanner = () => {
  return (
    <section className="max-w-[1400px] mx-auto px-4 md:px-6 mb-12 mt-6">
      <div className="relative w-full h-[320px] md:h-[450px] rounded-[40px] overflow-hidden bg-[#0A1A2F] flex items-center justify-center text-center">
        ...
        {/* Floating Camera - სურათის მიხედვით მარჯვენა დაბალ კუთხეში */}
